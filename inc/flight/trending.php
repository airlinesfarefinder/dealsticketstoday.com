...
<div id="trending">
                ...
                <div class="trending_item_container">
                    <div class="tre_img_wrap">
                        <div class="tre_img"  style=" 
                          background-image: url('./images/flight/31325.jpg');"
    ...
    background-repeat: no-repeat;
      background-image: url('./images/flight/people-portrait-with-plane-flying-sky.jpg');
            ...
            <div class="col-sm-4">
                <div class="trending_item_container">
                    <div class="tre_img_wrap">
                        ...
                        style=" 
                          background-image: url('./images/flight/2147959910.jpg');"
                        >
                            <div class="middle_dark_overlay"></div>
