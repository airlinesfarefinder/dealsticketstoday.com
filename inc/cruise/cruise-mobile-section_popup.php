...
<div class="reservation-container">
  <a href="tel:(888) 285-2767">
    <div class="heade">
      <div class="header-title">Cruise Reservations</div>
      <div class="phone-number">CALL US | 24/7: (888) 285-2767</div>
    </div>

    <div class="main-content">
      <div class="middle_dark_over"></div>
      <div class="content-inner">
        <h1 class="desk-title">Cruise Reservation Help Desk</h1>
       ...
       Speak with Our Cruise Specialists to Save Up to 40%
        </div>

        <button class="cta-button">
          Call Us Now
          <span class="phone-large">(888) 285-2767</span>
        </button>
      </div>
    </div>
