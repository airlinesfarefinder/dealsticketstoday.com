...
<div class="reservation-container">
  <a href="tel:(332) 233-7583">
    <div class="header">
      <div class="header-title">Rental Car Reservations</div>
      <div class="phone-number">CALL US | 24/7: (332) 233-7583</div>
    </div>

    <div class="main-content">
      <div class="middle_dark_over"></div>
      <div class="content-inner">
        <h1 class="desk-title">Car Rental Reservation Help Desk</h1>
      ...
      Speak with a Car Rental Advisor — Save as Much as 40%
        </div>

        <button class="cta-button">
          Call Us Now
          <span class="phone-large">(332) 233-7583</span>
        </button>
      </div>
    </div>
