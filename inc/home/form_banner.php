...
@keyframes slideBackground {
  0%, 33.32% {
    background-image: url('./images/home/boeing-1731385_1280.jpg');
  }
  33.33%, 66.65% {
    background-image: url('./images/cruise/vecteezy_luxury-cruise-ship-sails-across-calm-ocean-at-sunset-near_53368404.jpg');
  }
  66.66%, 100% {
    background-image: url('./images/carRental/frond-view-man-holding-cat-front-car.jpg');
  }
}
